...
INSERT INTO bit_member (userid, username, userpwd, emailid, emaildomain, joindate)
VALUES ('kimbit', '김비트', '1234', 'kimbit', 'bit.com', now());

INSERT INTO bit_member (username, userid , userpwd, joindate)
VALUES ('김비트', 'kimbit', '1234', now());

INSERT INTO bit_member (username, userid , userpwd, joindate)
VALUES
('김비트', 'kimbit', '1234', now()), 
('박비트', 'parkbit', '9876', now());

UPDATE bit_member
SET userpwd = 9876, emaildomain = 'bit.co.kr'
WHERE userid = 'kimbit';

...
@WebServlet(name="Forward2", urlPatterns="/testForward2")
public class TestForward2Servlet extends HttpServlet {
     @Override
...
//          super.doPost(req, resp);
     ...
     protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
          ...
          System.out.println("TestForward2Servlet");
